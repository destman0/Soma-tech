...
data conversion is taken from:
https://stackoverflow.com/questions/44748740/convert-byte-array-in-hex-to-char-array-or-string-type-arduino/44749986
...
int inflatePower = 0;
char wifiMacAddress_c[13] = "";
String wifiMacAddress_s;
byte macad[6];
...
void printWiFiData() {
  ...
  printMacAddress(macad);
  array_to_string(macad, 6, wifiMacAddress_c);
  wifiMacAddress_c[12] = '\0';
  wifiMacAddress_s = String(wifiMacAddress_c);
  Serial.print("MAC for OSC: ");
  Serial.println(wifiMacAddress_s);
}
